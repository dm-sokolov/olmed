...
if (Core_Array::getPost('apply') && $amount > 0)
{
	...
	$oShop_Order->postcode = strval(Core_Array::getPost('postcode'));
	$oShop_Order->address = strval(Core_Array::getPost('address'));
	$oShop_Order->surname = strval(Core_Array::getPost('surname'));
	$oShop_Order->name = strval(Core_Array::getPost('name'));
	$oShop_Order->patronymic = strval(Core_Array::getPost('patronymic'));
	$oShop_Order->company = strval(Core_Array::getPost('company'));
	$oShop_Order->phone = strval(Core_Array::getPost('phone'));
	$oShop_Order->fax = strval(Core_Array::getPost('fax'));
	$oShop_Order->email = strval(Core_Array::getPost('email'));
	$oShop_Order->description = strval(Core_Array::getPost('description'));
