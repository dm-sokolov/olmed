...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="/forum">
		...
		<xsl:if	test="last_siteuser/siteuser/node()">
			<p>
				<xsl:text>Последний зарегистрированный пользователь: </xsl:text><img style="margin: 0px 5px -4px 0px;" src="/hostcmsfiles/images/user.gif" /><a href="/users/info/{last_siteuser/siteuser/path}/">
