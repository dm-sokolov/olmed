...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="/site">
		...
		<form method="get" action="/search/">
			<input type="text" size="50" name="text" value="{query}" maxlength="200" class="input_buttom_search"/><xsl:text> </xsl:text>
	...
	<xsl:template match="search_page">
		<li>
			...
			<br/>
			<span class="description"><xsl:apply-templates select="url"/></span>
		</li>
	</xsl:template>
