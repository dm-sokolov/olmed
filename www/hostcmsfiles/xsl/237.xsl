...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="/informationsystem">
		...
		<xsl:choose>
			...
			<xsl:otherwise>
				<h1 hostcms:id="{$group}" hostcms:field="name" hostcms:entity="informationsystem_group" style="color:#046391;font-size:30px;line-height:35px;">
				...
				<xsl:if test="page = 0 and .//informationsystem_group[@id=$group]/description != ''">
					<div class="inner-text" hostcms:id="{$group}" hostcms:field="description" hostcms:entity="informationsystem_group" hostcms:type="wysiwyg"><xsl:value-of disable-output-escaping="yes" select=".//informationsystem_group[@id=$group]/description"/></div>
				</xsl:if>
