		...
		<html>
			...
			<body>
				<div class="main_div">
					...
					<p>
						<b>Поставщик:</b><xsl:text> </xsl:text><xsl:value-of select="company/name"/>
						<br />
						<b>ИНН/КПП:</b><xsl:text> </xsl:text><xsl:value-of select="company/tin"/>/<xsl:value-of select="/shop/company/kpp"/>
						<br />
						<b>ОГРН:</b><xsl:text> </xsl:text><xsl:value-of select="company/psrn"/>
						<br />
						<b>Адрес:</b><xsl:text> </xsl:text><xsl:value-of select="company/directory_address/full_address"/>
						<br />
						<b>Телефон:</b><xsl:text> </xsl:text><xsl:value-of select="company/directory_phone/value"/>
						<br />
						<b>Факс:</b><xsl:text> </xsl:text><xsl:value-of select="company/fax"/>
						<br />
						<b>E-mail:</b><xsl:text> </xsl:text><xsl:value-of select="company/directory_email/value"/>
						<br />
						<b>Сайт:</b><xsl:text> </xsl:text><xsl:value-of select="company/directory_website/value"/>
					</p>
					<p>
						<table cellpadding="1" cellspacing="0" width="100%">
							...
							<tr>
								<td class="td_main">ИНН<xsl:text> </xsl:text><xsl:value-of select="company/tin"/></td>
								<td class="td_main">КПП<xsl:text> </xsl:text><xsl:value-of select="company/kpp"/></td>
							...
							<tr>
								...
								<td class="td_main" style="border-bottom: black 1px solid; border-right: black 1px solid">
									<xsl:value-of select="/shop/company/correspondent_account"/>
								</td>
							</tr>
						</table>
					</p>
