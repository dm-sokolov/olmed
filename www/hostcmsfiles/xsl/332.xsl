...
<xsl:stylesheet version="1.0"
	...
	<xsl:variable name="city"> в Серове</xsl:variable>
	...
	<div class="specialist-item col-sm-6 mb-4">
		<div class="row">
			...
			<div class="specialist-info col-lg-7">
				...
				<button class="btn btn-primary" onclick="$.showXslTemplate('/callback/', 83, 357, ' ', '{$doctor}'); return false;">Запись к врачу</button>
			</div>
		</div>
	</div>
