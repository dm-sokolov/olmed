...
<xsl:variable name="topic_link">http://<xsl:value-of select="site/site_alias/alias_name_without_mask"/><xsl:value-of select="url"/><xsl:value-of select="forum_category/@id"/>/</xsl:variable>
...
-------------------------------------------------
<xsl:value-of select="forum_category/forum_topic/new/forum_topic_post/text" disable-output-escaping="yes"/>
-------------------------------------------------
