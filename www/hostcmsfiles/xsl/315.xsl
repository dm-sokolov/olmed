...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="informationsystem">
		<div class="bg-light p-4 mb-4">
			...
			<div id="specialistSlider" class="owl-carousel owl-theme owl-arrow-black">
			...
			<div class="row">
				...
				<div class="col-sm-7">
					...
					<xsl:if test="description != ''">
						<div class="mb-3 font-italic text-left"><xsl:value-of disable-output-escaping="yes" select="description"/></div>
					</xsl:if>
