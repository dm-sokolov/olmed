			...
			<div class="row search-field margin-bottom-20">
				<div class="col-xs-12">
					<form action="' . $oAdmin_Form_Controller->getPath() . '" method="GET">
						...
						<button type="submit" class="btn btn-default global-search-button" onclick="' . $oAdmin_Form_Controller->getAdminSendForm(array('action' => '', 'operation' => '', 'additionalParams' => $additionalParams)) . '"><i class="fa fa-search fa-fw"></i></button>
					</form>
				</div>
			</div>
		')
...
if (strlen($sGlobalSearch))
{
	$oAdmin_Form_Dataset
		->addCondition(array('open' => array()))
			->addCondition(array('where' => array('shortlink_dirs.id', '=', $sGlobalSearch)))
...
if (strlen($sGlobalSearch))
{
	$oAdmin_Form_Dataset
		->addCondition(array('open' => array()))
		->addCondition(array('where' => array('shortlinks.id', '=', $sGlobalSearch)))
		->addCondition(array('setOr' => array()))
