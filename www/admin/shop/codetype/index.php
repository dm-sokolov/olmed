...
// Код формы
$iAdmin_Form_Id = 297;
$sAdminFormAction = '/admin/shop/codetype/index.php';
...
$oAdmin_Form_Controller
	...
	->title(Core::_('Shop_Codetype.title'))
	->pageTitle(Core::_('Shop_Codetype.title'));
...
{
	$Shop_Codetype_Controller_Edit = Admin_Form_Action_Controller::factory(
		'Shop_Codetype_Controller_Edit', $oAdmin_Form_Action
	);
	...
	$oAdmin_Form_Controller->addAction($Shop_Codetype_Controller_Edit);
}
