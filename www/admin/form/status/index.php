...
$sAdminFormAction = '/admin/form/status/index.php';

$pageTitle = Core::_('Form_Status.form_statuses_title');
...
$oAdmin_Form_Entity_Menus->add(
	Admin_Form_Entity::factory('Menu')
		->name(Core::_('Form_Status.form_statuses_menu_add'))
		->icon('fa fa-plus')
...
$oAdminFormEntityBreadcrumbs
	->add(
		Admin_Form_Entity::factory('Breadcrumb')
			...
			->href($oAdmin_Form_Controller->getAdminLoadHref($sEventPath = '/admin/form/index.php'))
			->onclick($oAdmin_Form_Controller->getAdminLoadAjax($sEventPath))
	)
	->add(
		Admin_Form_Entity::factory('Breadcrumb')
			->name(Core::_('Form_Status.form_statuses_title'))
...
{
	$oForm_Status_Controller_Edit = Admin_Form_Action_Controller::factory(
		'Form_Status_Controller_Edit', $oAdminFormAction
	);

	// Добавляем контроллер редактирования контроллеру формы
	$oAdmin_Form_Controller->addAction($oForm_Status_Controller_Edit);

	// Крошки при редактировании
	$oForm_Status_Controller_Edit->addEntity($oAdminFormEntityBreadcrumbs);
}
...
$oAdmin_Form_Dataset = new Admin_Form_Dataset_Entity(
	Core_Entity::factory('Form_Status')
);
