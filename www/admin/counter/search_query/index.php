...
// Код формы
$iAdmin_Form_Id = 102;
$sAdminFormAction = '/admin/counter/search_query/index.php';

$sCounterPath = '/admin/counter/index.php';

$oAdmin_Form = Core_Entity::factory('Admin_Form', $iAdmin_Form_Id);

$sTitle = Core::_('Counter_Page.search_query');
...
!isset($oAdmin_Form_Controller->request['admin_form_filter_from_435']) && $oAdmin_Form_Controller->request['admin_form_filter_from_435'] = Core_Date::timestamp2date($iFromTimestamp);
!isset($oAdmin_Form_Controller->request['admin_form_filter_to_435']) &&	$oAdmin_Form_Controller->request['admin_form_filter_to_435'] = Core_Date::timestamp2date(time());
	...
	$(function(){
		...
		foreach ($aObjects as $key => $oObject)
		{
			...
			searchQueryDiagramData.push(
				{
					label:'<?php echo Core_Str::escapeJavascriptVariable(htmlspecialchars($oObject->search_query))?>',
		...
		var placeholder = $("#searchQueryDiagram");
