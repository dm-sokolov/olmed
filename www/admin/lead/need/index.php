...
$sAdminFormAction = '/admin/lead/need/index.php';

$pageTitle = Core::_('Lead_Need.form_statuses_title');
...
$oAdminFormEntityBreadcrumbs
	...
	->add(
		Admin_Form_Entity::factory('Breadcrumb')
			->name(Core::_('Lead_Need.form_statuses_title'))
...
{
	$oLead_Need_Controller_Edit = Admin_Form_Action_Controller::factory(
		'Lead_Need_Controller_Edit', $oAdminFormAction
	);

	// Добавляем контроллер редактирования контроллеру формы
	$oAdmin_Form_Controller->addAction($oLead_Need_Controller_Edit);

	// Крошки при редактировании
	$oLead_Need_Controller_Edit->addEntity($oAdminFormEntityBreadcrumbs);
}
