...
$sAdminFormAction = '/admin/lead/maturity/index.php';

$pageTitle = Core::_('Lead_Maturity.form_statuses_title');
...
$oAdminFormEntityBreadcrumbs
	...
	->add(
		Admin_Form_Entity::factory('Breadcrumb')
			->name(Core::_('Lead_Maturity.form_statuses_title'))
...
{
	$oLead_Maturity_Controller_Edit = Admin_Form_Action_Controller::factory(
		'Lead_Maturity_Controller_Edit', $oAdminFormAction
	);

	// Добавляем контроллер редактирования контроллеру формы
	$oAdmin_Form_Controller->addAction($oLead_Maturity_Controller_Edit);

	// Крошки при редактировании
	$oLead_Maturity_Controller_Edit->addEntity($oAdminFormEntityBreadcrumbs);
}
...
$oAdmin_Form_Dataset = new Admin_Form_Dataset_Entity(
	Core_Entity::factory('Lead_Maturity')
);
