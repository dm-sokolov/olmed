...
if (Core_Array::getPost('load_modal') && Core_Array::getPost('siteuser_email_id'))
{
	...
	$siteuser_email_id = intval(Core_Array::getPost('siteuser_email_id'));
		...
		if ($countAttachments)
		{
			...
			<div class="siteuser-mail-attachments">
				...
				foreach ($aSiteuser_Email_Attachments as $oSiteuser_Email_Attachment)
				{
					...
					$iconFile = '/admin/images/icons/' . Core_Array::get(Core::$mainConfig['fileIcons'], $ext, 'file.gif');
					?>
					<li class="margin-right-10">
						<a href="/admin/siteuser/email/index.php?downloadFile=<?php echo $oSiteuser_Email_Attachment->id?>" target="_blank" class="name">
