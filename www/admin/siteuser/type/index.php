...
$sAdminFormAction = '/admin/siteuser/type/index.php';
...
$pageTitle = Core::_('Siteuser_Type.siteuser_types_title');
...
{
	$oSiteuser_Type_Controller_Edit = Admin_Form_Action_Controller::factory(
		'Siteuser_Type_Controller_Edit', $oAdminFormAction
	);

	// Добавляем контроллер редактирования контроллеру формы
	$oAdmin_Form_Controller->addAction($oSiteuser_Type_Controller_Edit);

	// Крошки при редактировании
	$oSiteuser_Type_Controller_Edit->addEntity($oAdminFormEntityBreadcrumbs);
}
...
$oAdmin_Form_Dataset = new Admin_Form_Dataset_Entity(
	Core_Entity::factory('Siteuser_Type')
);
