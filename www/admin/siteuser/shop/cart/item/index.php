	...
	Admin_Form_Entity::factory('Code')
		->html('
			<div class="add-event margin-bottom-20">
				<form action="/admin/siteuser/shop/cart/item/index.php" method="POST">
					<div class="input-group">
						...
						<span class="input-group-btn bg-azure bordered-azure">
							<button id="sendForm" class="btn btn-azure" type="submit" onclick="' . $oAdmin_Form_Controller->getAdminSendForm('addShopItem', NULL, 'siteuser_id=' . $siteuser_id . '&shop_id=' . $shop_id) . '">
...
$oAdminFormActionAddShopItem = Core_Entity::factory('Admin_Form', $oAdmin_Form->id)
	->Admin_Form_Actions
	->getByName('addShopItem');
	...
	static public function onBeforeShowFooter($oAdmin_Form_Controller, $args)
	{
		...
		if ($siteuser_id && $shop_id)
		{
			...
			$sAmount = htmlspecialchars(
				sprintf("%.2f %s", $amount, $oShop->Shop_Currency->name)
			);
