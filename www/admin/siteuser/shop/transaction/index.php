	...
	Admin_Form_Entity::factory('Menu')
		...
		->add(
			Admin_Form_Entity::factory('Menu')
				...
				->img('/admin/images/transaction_add.gif')
				->icon('fa fa-plus')
				->href(
...
$oAdmin_Form_Dataset->addCondition(
	array('select' => array('shop_siteuser_transactions.*', array('shop_currencies.name', 'currency_name')))
)->addCondition(
	array('leftJoin' => array('shop_currencies', 'shop_siteuser_transactions.shop_currency_id', '=', 'shop_currencies.id'))
)->addCondition(
	array('where' =>
