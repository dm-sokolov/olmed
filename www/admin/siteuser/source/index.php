...
$sAdminFormAction = '/admin/siteuser/source/index.php';
...
$pageTitle = Core::_('Siteuser_Source.siteuser_sources_title');
...
$oAdminFormEntityBreadcrumbs
	...
	->add(
		Admin_Form_Entity::factory('Breadcrumb')
			->name(Core::_('Siteuser_Source.siteuser_sources_title'))
			->href(
...
if ($oAdminFormAction && $oAdmin_Form_Controller->getAction() == 'edit')
{
	$oSiteuser_Source_Controller_Edit = Admin_Form_Action_Controller::factory(
		'Siteuser_Source_Controller_Edit', $oAdminFormAction
	);
...
$oAdminFormDataset = new Admin_Form_Dataset_Entity(
	Core_Entity::factory('Siteuser_Source')
);
