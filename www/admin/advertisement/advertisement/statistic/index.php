...
$aImgAdditional[] = "admin_form_filter_from_181=" . htmlspecialchars(Core_Array::getRequest('admin_form_filter_from_181'));
$aImgAdditional[] = "admin_form_filter_to_181=" . htmlspecialchars(Core_Array::getRequest('admin_form_filter_to_181'));
...
$oCore_Html_Entity_Img
	->src("/admin/advertisement/advertisement/statistic/img.php?advertisement_id={$iAdvertisement}&rand=" . rand() . "&" . implode('&', $aImgAdditional))
	->execute();
