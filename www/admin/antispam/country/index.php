...
// Код формы
$iAdmin_Form_Id = 212;
$sAdminFormAction = '/admin/antispam/country/index.php';
...
$oAdmin_Form_Controller
	...
	->title(Core::_('Antispam_Country.title'))
	->pageTitle(Core::_('Antispam_Country.title'));
...
$oAdmin_Form_Entity_Breadcrumbs->add(
	...
	Admin_Form_Entity::factory('Breadcrumb')
		->name(Core::_('Antispam_Country.title'))
		->href(
...
if ($oAdmin_Form_Action && $oAdmin_Form_Controller->getAction() == 'edit')
{
	$Antispam_Country_Controller_Edit = Admin_Form_Action_Controller::factory(
		'Antispam_Country_Controller_Edit', $oAdmin_Form_Action
	);
...
$oAdmin_Form_Dataset = new Admin_Form_Dataset_Entity(
	Core_Entity::factory('Antispam_Country')
);
...
$oAdmin_Form_Dataset->addCondition(
	array('select' => array('antispam_countries.*',
		array('antispam_country_languages.name', 'country_name')
	))
)->addCondition(
		array('leftJoin' => array('antispam_country_languages', 'antispam_countries.id', '=', 'antispam_country_languages.antispam_country_id', array(
