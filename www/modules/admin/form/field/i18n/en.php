...
return array(
	...
	'form_forms_field_lng_name' => 'Field name',
	'form_forms_field_lng_description' => 'Field description',

	// Форма редактирования полей формы центра администрирования.
	'form_add_forms_field_title' => 'Add Back-end form field',
	'form_edit_forms_field_title' => 'Edit Back-end form field "%s"',

	'show_form_fields_menu_add_new_top' => 'Form field',

	'admin_form_tab_0' => 'Name',
	'admin_form_tab_3' => 'View',
	'name' => 'Key field (from table or model)',
	'sorting' => 'Sort',
	'type' => 'Field type',
	'view' => 'View',
	'format' => '<acronym title="Format line, default %s">Display format</acronym>',
