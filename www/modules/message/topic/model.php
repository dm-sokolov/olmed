...
class Message_Topic_Model extends Core_Entity
{
	...
	{
		$this->clearXmlTags()
			->addXmlTag('datetime', strftime($this->Message_Topics_By_Sender->Site->date_time_format, Core_Date::sql2timestamp($this->datetime)))
			->addXmlTag('date', strftime($this->Message_Topics_By_Sender->Site->date_format, Core_Date::sql2timestamp($this->datetime)))
