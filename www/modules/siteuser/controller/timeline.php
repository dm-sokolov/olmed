		...
		<ul class="timeline">
			...
			foreach ($aTmp as $datetime => $aTmpEntities)
			{
				...
				<li class="timeline-node">
					<a class="label label-<?php echo $color?>"><?php echo $datetime?></a>
				</li>
				<?php
				foreach ($aTmpEntities as $key => $oTmpEntity)
				{
					...
					switch ($oTmpEntity->type)
					{
						...
						case 1:
							...
							$title = Core::_('Shop_Order.popover_title', $oShop_Order->invoice);
						...
						case 2:
							...
							$text = strlen($oShop_Item->description)
