...
/**
 * Siteuser_Source_Controller_Edit
 *
 * @package HostCMS
 * @subpackage Siteuser
 * @version 6.x
 ...
 */
class Siteuser_Source_Controller_Edit extends Admin_Form_Action_Controller_Type_Edit
{
	/**
	 * Set object
	...
	public function setObject($object)
	{
		...
		$this->title($this->_object->id
			? Core::_('Siteuser_Source.edit_siteuser_sources_title', $this->_object->name)
			: Core::_('Siteuser_Source.add_siteuser_sources_title'));
