			...
			foreach ($aSiteuser_Email_Attachments as $oSiteuser_Email_Attachment)
			{
				$oMainRow7->add(
					Admin_Form_Entity::factory('Div')
						->class('form-group col-xs-12 no-margin-bottom')
						->add(
							Admin_Form_Entity::factory('File')
								...
								->largeImage(
									array(
										'path' => '/admin/siteuser/email/index.php?downloadFile=' . $oSiteuser_Email_Attachment->id . '&filename=' . $oSiteuser_Email_Attachment->name,
										'show_params' => FALSE,
										'originalName' => $oSiteuser_Email_Attachment->name,
										'delete_onclick' => "$.adminLoad({path: '/admin/siteuser/email/index.php', additionalParams: 'hostcms[checked][0][{$this->_object->id}]=1', operation: '{$oSiteuser_Email_Attachment->id}', action: 'deleteFile', windowId: '{$windowId}'}); return false",
										'delete_href' => '',
								...
								->divAttr(array('id' => "file_{$oSiteuser_Email_Attachment->id}", 'class' => 'input-group col-xs-12'))
						)
				);
			}
				...
				Admin_Form_Entity::factory('Div')
					...
					->add(
						Admin_Form_Entity::factory('File')
							...
							->divAttr(array('id' => 'file', 'class' => 'add-email-attachment'))
