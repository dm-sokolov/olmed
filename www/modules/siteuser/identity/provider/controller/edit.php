...
class Siteuser_Identity_Provider_Controller_Edit extends Admin_Form_Action_Controller_Type_Edit
{
	...
	public function setObject($object)
	{
		...
		$this->title($this->_object->id
			? Core::_('Siteuser_Identity_Provider.form_edit_add_title_edit', $this->_object->name)
		...
		$sFilePath = is_file($this->_object->getDirPath() . $object->image)
			? '/' . $this->_object->getDirHref() . $object->image
			: '';
