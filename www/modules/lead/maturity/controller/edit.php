 ...
 */
class Lead_Maturity_Controller_Edit extends Admin_Form_Action_Controller_Type_Edit
{
	/**
	 * Set object
	...
	public function setObject($object)
	{
		...
		$this->title($this->_object->id
			? Core::_('Lead_Maturity.edit_title', $this->_object->name)
			: Core::_('Lead_Maturity.add_title'));
